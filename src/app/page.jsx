        ...
        <section className="section-1 w-[50%]">
          ...
          <nav className="nav flex flex-col justify-center items-center mt-[6rem]">
            <div className="login">
              ...
              <p className="mt-[0.5rem] text-[#777] text-sm leading-6">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam
                corrupti praesentium ipsum nam recusandae, quo, iste distinctio
                quibusdam reprehenderit molestiae vitae voluptas perferendis
                molestias eligendi pariatur nisi labore architecto quae.
              </p>
              <form
                onSubmit={handleSubmit}
                className="flex flex-col mt-[1.5rem] text-[#222]"
              >
                <div className="email-input">
                  <label
                    htmlFor="UserEmail"
                    className="text-cyan-800 text-[0.875rem] font-bold"
                  >
                    Email Address
                  </label>
                  <br />
                ...
                <div className="remember-me flex items-center gap-[0.25rem]">
                  ...
                  />
                  <label htmlFor="remember-me" className="text-[.875rem]">
                    Remember Me
                  </label>
                </div>
                ...
                <button
                  type="submit"
                  className="mt-[1rem] bg-cyan-800 text-white py-[0.5rem] px-[6rem] rounded-sm w-100 duration-500 ease-in-out hover:bg-cyan-600 cursor-pointer"
                >
                  Login
                </button>
              </form>
              <p className="mt-[1rem] text-[0.875rem]">
                Don't have an account?{" "}
                <Link href="/signup">
                  <span className="text-cyan-600 underline">SignUp</span>
                </Link>
              </p>
              <div className="demo-account mt-5 text-[0.875rem] text-gray-600">
                <h5>Demo Account</h5>
                <p>Email: alihelal.eng@yahoo.com</p>
                <p>Password: alihelal123</p>
              </div>
            </div>
          </nav>
        </section>
